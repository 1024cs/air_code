#ifndef IO_FLOW_TRACE_MSR_H
#define IO_FLOW_TRACE_MSR_H
...
{
class IO_Flow_Trace_MSR : public IO_Flow_Base
{
public:
	IO_Flow_Trace_MSR(const sim_object_id_type &name, uint16_t flow_id, LHA_type start_lsa_on_device, LHA_type end_lsa_on_device, uint16_t io_queue_id,
