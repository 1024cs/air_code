...
namespace NVM
{
	namespace FlashMemory
	{
		...
		public:
			Flash_Chip(const sim_object_id_type& id, flash_channel_ID_type channelID, flash_chip_ID_type localChipID,
		...
		private:
			...
			sim_time_type *_readLatency, *_programLatency, _eraseLatency;   /* LSB & CSB & MSB */
			...
			std::vector<ChipReadySignalHandlerType> connectedReadyHandlers;  /* 只有src/ssd/NVM_PHY_ONFI_NVDDR2.cpp中handle_ready_signal_from_chip函数 */
		};
	}
}
