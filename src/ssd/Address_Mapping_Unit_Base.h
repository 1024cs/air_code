...
namespace SSD_Components
{
	...
	/* CWDP the ordering of Channel-first, Chip-second, Die-third and Plane-fourth */
	...
	public:
		...
		virtual void Translate_lpa_to_ppa_and_dispatch(const std::list<NVM_Transaction*>& transactionList) = 0;  /* cache提交未完成的事务到mapping的入口 */
	...
	protected:
		...
		unsigned int total_logical_pages_no = 0;  /* (double)total_physical_pages_no * (1 - overprovisioning_ratio) */
		...
		unsigned int total_physical_pages_no = 0;  /* page_no_per_channel * ChannelCount */
