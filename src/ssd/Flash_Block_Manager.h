...
namespace SSD_Components
{
	...
	public:
		...
		void Invalidate_page_in_block(const stream_id_type streamID, const NVM::FlashMemory::Physical_Page_Address& address);  /* 更新plane_record的统计信息 并设置Invalid_page_bitmap相关位 */
		...
		unsigned int Get_pool_size(const NVM::FlashMemory::Physical_Page_Address& plane_address);  /* return Free_block_pool.size() */
	private:
	};
}
