#ifndef DATA_CACHE_MANAGER_FLASH_Catcher_H
#define DATA_CACHE_MANAGER_FLASH_Catcher_H
...
namespace SSD_Components
{
	...
	Assumed hardware structure:
			...
			|     DRAM Data_Cache_Flash Main Data Space                   |   Back Pressure Space  | ---------->To the flash backend
			 --------------------------------------------------|------------------------
	*/
	class Data_Cache_Manager_Flash_Catcher : public Data_Cache_Manager_Base
	{
	public:
		Data_Cache_Manager_Flash_Catcher(const sim_object_id_type& id, Host_Interface_Base* host_interface, NVM_Firmware* firmware, NVM_PHY_ONFI* flash_controller,
		...
		~Data_Cache_Manager_Flash_Catcher();
	...
	private:
		...
		/* zy1024cs */
		void service_dram_access_request(Memory_Transfer_Info* request_info, unsigned int Size_in_bytes_bypass);
	};
}

#endif // !DATA_CACHE_MANAGER_FLASH_Catcher_H
